...
/*static */void History::updateHistory(IgelSearch * pSearch, const std::vector<Move>& quetMoves, int ply, int bonus)
{
    assert(ply < MAX_PLY);
...
/*static */void History::setKillerMove(IgelSearch * pSearch, Move mv, int ply)
{
...
/*static */void History::fetchHistory(IgelSearch * pSearch, Move mv, int ply, HistoryHeuristics & hh)
{
    assert(ply < MAX_PLY);
