...
EVAL Evaluator::evaluate(IgelPosition & pos)
{
    U64 kingZone[2];
    int attackKing[2];
    PawnHashEntry* ps;
...
#if defined(EVAL_NNUE)
    nnueEval = static_cast<EVAL>(Eval::IGEL_NNUE::evaluate(pos));
...
Pair Evaluator::evaluatePawns(IgelPosition & pos, U64 occ, PawnHashEntry ** pps)
{
...
Pair Evaluator::evaluatePawn(IgelPosition & pos, COLOR side, U64 occ, PawnHashEntry * ps)
{
    Pair score{};
...
Pair Evaluator::evaluatePawnsAttacks(IgelPosition & pos)
{
    Pair score{};
...
Pair Evaluator::evaluatePawnAttacks(IgelPosition & pos, COLOR side)
{
    Pair score{};
...
Pair Evaluator::evaluateKnights(IgelPosition& pos, U64 kingZone[], int attackers[], PawnHashEntry * ps)
{
    Pair score{};
...
Pair Evaluator::evaluateKnight(IgelPosition & pos, COLOR side, U64 kingZone[], int attackers[], PawnHashEntry * ps)
{
    Pair score{};
...
Pair Evaluator::evaluateBishops(IgelPosition & pos, U64 occ, U64 kingZone[], int attackers[], PawnHashEntry * ps)
{
    Pair score{};
...
Pair Evaluator::evaluateBishop(IgelPosition & pos, COLOR side, U64 occ, U64 kingZone[], int attackers[], PawnHashEntry * ps)
{
    Pair score{};
...
Pair Evaluator::evaluateRooks(IgelPosition & pos, U64 occ, U64 kingZone[], int attackers[], PawnHashEntry * ps)
{
    Pair score{};
...
Pair Evaluator::evaluateRook(IgelPosition & pos, COLOR side, U64 occ, U64 kingZone[], int attackers[], PawnHashEntry* ps)
{
    Pair score{};
...
Pair Evaluator::evaluateQueens(IgelPosition & pos, U64 occ, U64 kingZone[], int attackers[])
{
    Pair score{};
...
Pair Evaluator::evaluateQueen(IgelPosition & pos, COLOR side, U64 occ, U64 kingZone[], int attackers[])
{
    Pair score{};
...
Pair Evaluator::evaluateKingsAttackers(IgelPosition & pos, int attackers[])
{
    Pair score{};
...
Pair Evaluator::evaluateKingAttackers(IgelPosition& pos, COLOR side, int attackers[])
{
    Pair score{};
...
Pair Evaluator::evaluateKings(IgelPosition & pos, U64 occ, PawnHashEntry * ps, int attackers[])
{
    Pair score{};
...
Pair Evaluator::evaluateKing(IgelPosition & pos, COLOR side, U64 occ, PawnHashEntry * ps, int attackers[])
{
    Pair score{};
...
Pair Evaluator::evaluatePiecesPairs(IgelPosition & pos)
{
    Pair score{};
...
Pair Evaluator::evaluatePiecePairs(IgelPosition & pos, COLOR side)
{
    Pair score{};
...
Pair Evaluator::evaluateThreats(IgelPosition & pos)
{
    Pair score{};
...
Pair Evaluator::evaluateThreat(IgelPosition & pos, COLOR side)
{
    Pair score{};
...
void PawnHashEntry::Read(const IgelPosition& pos)
{
