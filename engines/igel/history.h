...
public:
    static void updateHistory(IgelSearch * pSearch, const std::vector<Move> & quetMoves, int ply, int bonus);
    static void setKillerMove(IgelSearch * pSearch, Move mv, int ply);
    static void fetchHistory(IgelSearch * pSearch, Move mv, int ply, HistoryHeuristics & hh);
