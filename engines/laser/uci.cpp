...
static string name = "Laser";
static string version = "1.8 beta";
static string author = "Jeffrey An and Michael An";
static std::thread searchThread;

static Board board = fenToBoard(STARTPOS);
