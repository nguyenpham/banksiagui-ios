...
#pragma warning(push)
#pragma warning(disable: 26496 26814)
namespace {
	...
	inline Piece ToPiece(TBPiece p)  noexcept { return PieceMap[p]; }
	inline TBPiece ToTBPiece(Piece p) noexcept { return TBPieceMap[p]; }
	...
	inline WDLScore operator-(WDLScore d) noexcept { return WDLScore(-int(d)); }
	inline Square operator^=(Square& s, int i) noexcept { return s = Square(int(s) ^ i); }
	inline Square operator^(Square s, int i) noexcept { return Square(int(s) ^ i); }
	...
	int LeadPawnIdx[6][64]; // [leadPawnsCnt][64]
	int LeadPawnsSize[6][4];       // [leadPawnsCnt][FILE_A..FILE_D]

	// Comparison function to sort leading pawns in ascending MapPawns[] order
	bool pawns_comp(Square i, Square j)  noexcept { return MapPawns[i] < MapPawns[j]; }
	int off_A1H8(Square sq) noexcept { return (sq >> 3) - (sq & 7); }
	...
	template<> inline void swap_endian<uint8_t>(uint8_t&)  noexcept {}

	template<typename T, int LE> T number(void* addr) noexcept
	{
	...
	template <typename T> int sign_of(T val)  noexcept {
	...
	class TBFile : public std::ifstream {
		...
		inline static std::unordered_map<std::string, void*> four_men_map = {
			{ "KBBvK.rtbw", &KBBvK_rtbw }, { "KBBvK.rtbz", &KBBvK_rtbz }, { "KBNvK.rtbw", &KBNvK_rtbw }, { "KBNvK.rtbz", &KBNvK_rtbz },
			{ "KBPvK.rtbw", &KBPvK_rtbw }, { "KBPvK.rtbz", &KBPvK_rtbz }, { "KBvK.rtbw", &KBvK_rtbw }, { "KBvK.rtbz", &KBvK_rtbz },
			{ "KBvKB.rtbw", &KBvKB_rtbw }, { "KBvKB.rtbz", &KBvKB_rtbz }, { "KBvKN.rtbw", &KBvKN_rtbw }, { "KBvKN.rtbz", &KBvKN_rtbz },
			{ "KBvKP.rtbw", &KBvKP_rtbw }, { "KBvKP.rtbz", &KBvKP_rtbz }, { "KNNvK.rtbw", &KNNvK_rtbw }, { "KNNvK.rtbz", &KNNvK_rtbz },
			{ "KNPvK.rtbw", &KNPvK_rtbw }, { "KNPvK.rtbz", &KNPvK_rtbz }, { "KNvK.rtbw", &KNvK_rtbw }, { "KNvK.rtbz", &KNvK_rtbz },
			{ "KNvKN.rtbw", &KNvKN_rtbw }, { "KNvKN.rtbz", &KNvKN_rtbz }, { "KNvKP.rtbw", &KNvKP_rtbw }, { "KNvKP.rtbz", &KNvKP_rtbz },
			{ "KPPvK.rtbw", &KPPvK_rtbw }, { "KPPvK.rtbz", &KPPvK_rtbz }, { "KPvK.rtbw", &KPvK_rtbw }, { "KPvK.rtbz", &KPvK_rtbz },
			{ "KPvKP.rtbw", &KPvKP_rtbw }, { "KPvKP.rtbz", &KPvKP_rtbz }, { "KQBvK.rtbw", &KQBvK_rtbw }, { "KQBvK.rtbz", &KQBvK_rtbz },
			{ "KQNvK.rtbw", &KQNvK_rtbw }, { "KQNvK.rtbz", &KQNvK_rtbz }, { "KQPvK.rtbw", &KQPvK_rtbw }, { "KQPvK.rtbz", &KQPvK_rtbz },
			{ "KQQvK.rtbw", &KQQvK_rtbw }, { "KQQvK.rtbz", &KQQvK_rtbz }, { "KQRvK.rtbw", &KQRvK_rtbw }, { "KQRvK.rtbz", &KQRvK_rtbz },
			{ "KQvK.rtbw", &KQvK_rtbw }, { "KQvK.rtbz", &KQvK_rtbz }, { "KQvKB.rtbw", &KQvKB_rtbw }, { "KQvKB.rtbz", &KQvKB_rtbz },
			{ "KQvKN.rtbw", &KQvKN_rtbw }, { "KQvKN.rtbz", &KQvKN_rtbz }, { "KQvKP.rtbw", &KQvKP_rtbw }, { "KQvKP.rtbz", &KQvKP_rtbz },
			{ "KQvKQ.rtbw", &KQvKQ_rtbw }, { "KQvKQ.rtbz", &KQvKQ_rtbz }, { "KQvKR.rtbw", &KQvKR_rtbw }, { "KQvKR.rtbz", &KQvKR_rtbz },
			{ "KRBvK.rtbw", &KRBvK_rtbw }, { "KRBvK.rtbz", &KRBvK_rtbz }, { "KRNvK.rtbw", &KRNvK_rtbw }, { "KRNvK.rtbz", &KRNvK_rtbz },
			{ "KRPvK.rtbw", &KRPvK_rtbw }, { "KRPvK.rtbz", &KRPvK_rtbz }, { "KRRvK.rtbw", &KRRvK_rtbw }, { "KRRvK.rtbz", &KRRvK_rtbz },
			{ "KRvK.rtbw", &KRvK_rtbw }, { "KRvK.rtbz", &KRvK_rtbz }, { "KRvKB.rtbw", &KRvKB_rtbw }, { "KRvKB.rtbz", &KRvKB_rtbz },
			{ "KRvKN.rtbw", &KRvKN_rtbw }, { "KRvKN.rtbz", &KRvKN_rtbz }, { "KRvKP.rtbw", &KRvKP_rtbw }, { "KRvKP.rtbz", &KRvKP_rtbz },
			{ "KRvKR.rtbw", &KRvKR_rtbw }, { "KRvKR.rtbz", &KRvKR_rtbz }
		};
	...
	public:
		...
		TBFile(const std::string& f) {
			...
			std::string path = settings::options.getString(settings::OPTION_SYZYGY_PATH);
			if ((path.size() == 0 || !path.compare(settings::DEFAULT_SYZYGY_PATH)) && four_men_map.find(f) != four_men_map.end()) {
				address = four_men_map.at(f);
				return;
			}
	...
	struct TBTable {
		...
		PairsData* get(int stm, int f)  noexcept {
			return &items[stm % Sides][hasPawns ? f : 0];
		}

		TBTable() noexcept : ready(false), baseAddress(nullptr) {}
		...
		TBTable& operator=(const TBTable&) = default;
		TBTable(TBTable&&) = default;
		TBTable& operator=(TBTable&&) = default;
	};
	...
	template<>
	TBTable<DTZ>::TBTable(const TBTable<WDL>& wdl) noexcept : TBTable() {
	...
	class TBTables {
		...
		static constexpr int Size = 1 << 12; // 64K table, indexed by key's 16 lsb
	...
	public:
		...
		size_t size() const noexcept { return wdlTable.size(); }
	...
	void TBTables::add(const std::vector<PieceType>& pieces) {
		...
		if (code.length() > 4) {
			...
			TBFile file(code1.insert(code1.find('K', 1), "v") + ".rtbw"); // KRK -> KRvK
	...
	int decompress_pairs(PairsData* d, uint64_t idx) noexcept {
	...
	WDLScore map_score(TBTable<WDL>*, File, int value, WDLScore) noexcept { return WDLScore(value - 2); }
	...
	template<typename T>
	void set_groups(T& e, PairsData* d, int order[], File f) noexcept {
	...
	uint8_t* set_dtz_map(TBTable<WDL>&, uint8_t* data, File) noexcept { return data; }

	uint8_t* set_dtz_map(TBTable<DTZ>& e, uint8_t* data, File maxFile) noexcept {
		...
		for (PieceType p2 = PAWN; p2 >= p1 && p2 < KING; --p2) {
			...
			for (PieceType p3 = PAWN; p3 >= p2 && p3 < KING; --p3) {
				...
				for (PieceType p4 = PAWN; p4 >= p3 && p4 < KING; --p4) {
					...
					for (PieceType p5 = PAWN; p5 >= p4 && p5 < KING; --p5)
						TBTables.add({ KING, p1, p2, p3, p4, p5, KING });

					for (PieceType p5 = PAWN; p5 >= QUEEN && p5 < KING; --p5)
...
bool tablebases::IsInTB(MaterialKey_t key) noexcept
{
	return TBTables.get<WDL>(14695981039346656037ull * key) != nullptr;
}
