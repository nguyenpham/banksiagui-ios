...
- attacks.c: add "static" to PawnAttacks
- uci.c:
+ convert main function into ethereal_initialize() and ethereal_uci_cmd()
+ printf -> sprintf & engine_message_c
+ convert some char* to const char* (for strEquals, strStartsWith, strContains, uciSetOption, uciPosition)
