...
extern const int xiphos_pawn_storm[2][BOARD_SIZE];
...
extern const int xiphos_rook_file_bonus[N_PHASES][2];
extern const int xiphos_bishop_pair[N_PHASES];
extern const int xiphos_pawn_mobility[N_PHASES];
