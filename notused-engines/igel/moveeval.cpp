...
/*static*/ bool MoveEval::isSpecialMove(const Move & mv, IgelSearch * pSearch)
{
...
/*static */void MoveEval::sortMoves(IgelSearch * pSearch, MoveList & mvlist, Move hashMove, int ply)
{
...
/*static */EVAL MoveEval::SEE_Exchange(IgelSearch * pSearch, FLD to, COLOR side, EVAL currScore, EVAL target, U64 occ)
{
...
/*static */EVAL MoveEval::SEE(IgelSearch * pSearch, const Move & mv)
{
    FLD from = mv.From();
    FLD to = mv.To();
    PIECE piece = mv.Piece();
